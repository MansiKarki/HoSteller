      ...
      <div className="flex gap-6 items-start">
            ...
            <div className="space-y-6">
              ...
              {warden && (
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  <h3 className="font-bold text-gray-800 mb-4">Warden Information</h3>
        ...
        <div className="flex flex-col gap-4" style={{ flex: "0 0 30%" }}>
          ...
          <div className="bg-blue-50 rounded-2xl border border-blue-200 p-5">
            <h3 className="font-bold text-blue-800 text-sm mb-3">Hostel Rules</h3>
          ...
          <div className="bg-red-50 rounded-2xl border border-red-200 p-5">
            <h3 className="font-bold text-red-800 text-sm mb-3">Emergency</h3>
